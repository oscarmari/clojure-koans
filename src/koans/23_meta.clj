...
(meditations
 ...
 (comment
   (meta (with-meta {:meta-works-on-a-map true} {:foo "foo"})) ;; this works

   ;;The following expressions are equivalent
   (meta ^{:metdata-to-be-added true} [1 2 3])
   (meta (with-meta [1 2 3] {:metdata-to-be-added true} ))
   )
  ...
  (= nil (meta (merge {:a 1 :b 2}
                     '^{:foo :bar} {:b 3 :c 4}))) ;;why? this is not cool
